...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Daniel', // 您的昵称 例如 tangly1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '光影障目', // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '个人博客', // 站点描述，被notion中的页面描述覆盖
